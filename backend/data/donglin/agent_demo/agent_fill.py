...
ROOT = Path("C:/Users/yingx/audit-knowledge")
INPUT = ROOT / "input"
ONTOLOGY = ROOT / "pilot_jsdw"
...
def fill_A6(ontology, raw, prov: Provenance):
    ...
    summary = {
        ...
        "closing_audited": round(aux_dr_total, 2),
    ...
    prov.record(PAPER, "summary.closing_audited", summary["closing_audited"], "RuleDerived",
        ["📜 Rule::AR-RULE-001"],
        "审定数 = aux_dr_total (贷方部分已重分类移出)",
        rule_code="AR-RULE-001")
